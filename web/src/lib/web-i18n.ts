...
type WebTexts = {
  ...
  painelFinanceiro: string;
  ganheDinheiroIndicando: string;
  meuCodigoIndicacao: string;
  meuLinkIndicacao: string;
  copiarCodigo: string;
  copiarLink: string;
  compartilharConvite: string;
  historicoComissoes: string;
  indicados: string;
  assinantesAtivos: string;
  comissaoPendente: string;
  comissaoLiberada: string;
  comissaoAprovada: string;
  comissaoPaga: string;
  comissaoCancelada: string;
  pixBloqueado: string;
  expiradaPorPlano: string;
  expiradaPorTempo: string;
  nenhumaComissao: string;
...
const TEXTS: Record<WebLang, WebTexts> = {
  pt: {
    ...
    painelFinanceiro: "Painel financeiro",
    ganheDinheiroIndicando: "Ganhe dinheiro indicando o INSANE GPS",
    meuCodigoIndicacao: "Seu codigo",
    meuLinkIndicacao: "Seu link",
    copiarCodigo: "Copiar codigo",
    copiarLink: "Copiar link",
    compartilharConvite: "Compartilhar convite",
    historicoComissoes: "Ver historico",
    indicados: "Indicados",
    ...
    comissaoPaga: "Paga",
    comissaoCancelada: "Cancelada",
    pixBloqueado: "PIX bloqueado",
    expiradaPorPlano: "Expirada por plano",
    expiradaPorTempo: "Expirada por tempo",
    nenhumaComissao: "Voce ainda nao possui comissoes.",
...
receiveCodeInstruction:"Informe este código somente quando receber o pedido.",
  ...
  en: {
    ...
    painelFinanceiro: "Financial panel",
    ganheDinheiroIndicando: "Earn money by referring INSANE GPS",
    meuCodigoIndicacao: "Your code",
    meuLinkIndicacao: "Your link",
    copiarCodigo: "Copy code",
    copiarLink: "Copy link",
    compartilharConvite: "Share invite",
    historicoComissoes: "View history",
    indicados: "Referrals",
    assinantesAtivos: "Active subscribers",
    comissaoPendente: "Pending",
    comissaoLiberada: "Released",
    comissaoAprovada: "Approved",
    comissaoPaga: "Paid",
    comissaoCancelada: "Canceled",
    pixBloqueado: "PIX blocked",
    expiradaPorPlano: "Expired by plan",
    expiradaPorTempo: "Expired by time",
    nenhumaComissao: "You do not have commissions yet.",
...
receiveCodeInstruction:"Share this code only when you receive the order.",
  ...
  es: {
    ...
    painelFinanceiro: "Panel financiero",
    ganheDinheiroIndicando: "Gana dinero recomendando INSANE GPS",
    meuCodigoIndicacao: "Tu codigo",
    meuLinkIndicacao: "Tu enlace",
    copiarCodigo: "Copiar codigo",
    copiarLink: "Copiar enlace",
    compartilharConvite: "Compartir invitacion",
    historicoComissoes: "Ver historial",
    indicados: "Referidos",
    assinantesAtivos: "Suscriptores activos",
    comissaoPendente: "Pendiente",
    comissaoLiberada: "Liberada",
    comissaoAprovada: "Aprobada",
    comissaoPaga: "Pagada",
    comissaoCancelada: "Cancelada",
    pixBloqueado: "PIX bloqueado",
    expiradaPorPlano: "Expirada por plan",
    expiradaPorTempo: "Expirada por tiempo",
    nenhumaComissao: "Aun no tienes comisiones.",
...
receiveCodeInstruction:"Comparte este código solo cuando recibas el pedido.",
  ...
  fr: {
    ...
    painelFinanceiro: "Panneau financier",
    ganheDinheiroIndicando: "Gagnez de l'argent en recommandant INSANE GPS",
    meuCodigoIndicacao: "Votre code",
    meuLinkIndicacao: "Votre lien",
    copiarCodigo: "Copier le code",
    copiarLink: "Copier le lien",
    compartilharConvite: "Partager l'invitation",
    historicoComissoes: "Voir l'historique",
    indicados: "Filleuls",
    assinantesAtivos: "Abonnes actifs",
    comissaoPendente: "En attente",
    comissaoLiberada: "Liberee",
    comissaoAprovada: "Approuvee",
    comissaoPaga: "Payee",
    comissaoCancelada: "Annulee",
    pixBloqueado: "PIX bloque",
    expiradaPorPlano: "Expiree par plan",
    expiradaPorTempo: "Expiree par temps",
    nenhumaComissao: "Vous n'avez pas encore de commissions.",
...
receiveCodeInstruction:"Communiquez ce code uniquement lorsque vous recevez la commande.",
  ...
  de: {
    ...
    painelFinanceiro: "Finanzpanel",
    ganheDinheiroIndicando: "Verdiene Geld mit Empfehlungen fuer INSANE GPS",
    meuCodigoIndicacao: "Dein Code",
    meuLinkIndicacao: "Dein Link",
    copiarCodigo: "Code kopieren",
    copiarLink: "Link kopieren",
    compartilharConvite: "Einladung teilen",
    historicoComissoes: "Verlauf anzeigen",
    indicados: "Empfohlene",
    assinantesAtivos: "Aktive Abonnenten",
    comissaoPendente: "Ausstehend",
    comissaoLiberada: "Freigegeben",
    comissaoAprovada: "Genehmigt",
    comissaoPaga: "Bezahlt",
    comissaoCancelada: "Storniert",
    pixBloqueado: "PIX blockiert",
    expiradaPorPlano: "Nach Plan abgelaufen",
    expiradaPorTempo: "Nach Zeit abgelaufen",
    nenhumaComissao: "Du hast noch keine Provisionen.",
